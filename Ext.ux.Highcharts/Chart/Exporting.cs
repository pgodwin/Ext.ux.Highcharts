...
namespace Ext.ux.Highcharts.Chart
{
        ...
        [DefaultValue(null)]
        [Category("HighCharts")]
        [ConfigOption("buttons", typeof(LazyControlJsonConverter))]
        ...
        public virtual Buttons Buttons
        {
            get
            {
            ...
            set
            {
                ...
                {
                    this.Controls.Remove(this._Buttons);
                    this.LazyItems.Remove(this._Buttons);
                }
                ...
                if (this._Buttons != null)
                {
                    this.LazyItems.Add(this._Buttons);
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("buttons", new ConfigOption("buttons", new SerializationOptions("buttons", typeof(LazyControlJsonConverter)), null, this.Buttons));
