...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// 
        /// </summary>
        public partial class SplinePlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private SplinePlotOptionsEvents events;
            ...
            public SplinePlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new SplinePlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class SplinePlotOptionsEvents : ComponentListeners
        {
