...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// 
        /// </summary>
        public partial class ScatterPlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private ScatterPlotOptionsEvents events;
            ...
            public ScatterPlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new ScatterPlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class ScatterPlotOptionsEvents : ComponentListeners
        {
