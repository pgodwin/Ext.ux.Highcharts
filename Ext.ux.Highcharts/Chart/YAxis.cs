...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// </summary>
        public partial class YAxis : Observable
        {
            ...
            public bool? EndOnTick
            {
                get
                {
                    return this.State.Get<bool?>("EndOnTick", true);
                }
                set
                {
            ...
            public string GridLineInterpolation
            {
                get
                {
                    return this.State.Get<string>("GridLineInterpolation", @"null");
                }
                set
                {
                    this.State.Set("GridLineInterpolation", value);
                }
            }
            ...
            public double? GridLineWidth
            {
                get
                {
                    return this.State.Get<double?>("GridLineWidth", 1);
                }
                set
                {
            ...
            public string MaxColor
            {
                get
                {
                    return this.State.Get<string>("MaxColor", @"#102D4C");
                }
                set
                {
                    this.State.Set("MaxColor", value);
                }
            }
            ...
            public double? MaxPadding
            {
                get
                {
                    return this.State.Get<double?>("MaxPadding", 0.05);
                }
                set
                {
            ...
            public string MinColor
            {
                get
                {
                    return this.State.Get<string>("MinColor", @"#EFEFFF");
                }
                set
                {
                    this.State.Set("MinColor", value);
                }
            }
            ...
            public double? MinPadding
            {
                get
                {
                    return this.State.Get<double?>("MinPadding", 0.05);
                }
                set
                {
            ...
            public bool? ReversedStacks
            {
                get
                {
                    return this.State.Get<bool?>("ReversedStacks", true);
                }
                set
                {
                    this.State.Set("ReversedStacks", value);
                }
            }
            ...
            public bool? StartOnTick
            {
                get
                {
                    return this.State.Get<bool?>("StartOnTick", true);
                }
                set
                {
            ...
            public string Stops
            {
                get
                {
                    return this.State.Get<string>("Stops", "");
                }
                set
                {
                    this.State.Set("Stops", value);
                }
            }
            ...
            public double? TickWidth
            {
                get
                {
                    return this.State.Get<double?>("TickWidth", 0);
                }
                set
                {
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("endOnTick", new ConfigOption("endOnTick", null, true, this.EndOnTick));
                ...
                list.Add("gridLineInterpolation", new ConfigOption("gridLineInterpolation", null, @"null", this.GridLineInterpolation));

                list.Add("gridLineWidth", new ConfigOption("gridLineWidth", null, 1, this.GridLineWidth));
                ...
                list.Add("maxColor", new ConfigOption("maxColor", null, @"#102D4C", this.MaxColor));

                list.Add("maxPadding", new ConfigOption("maxPadding", null, 0.05, this.MaxPadding));

                list.Add("maxZoom", new ConfigOption("maxZoom", null, null, this.MaxZoom));

                list.Add("min", new ConfigOption("min", null, null, this.Min));

                list.Add("minColor", new ConfigOption("minColor", null, @"#EFEFFF", this.MinColor));

                list.Add("minPadding", new ConfigOption("minPadding", null, 0.05, this.MinPadding));
                ...
                list.Add("reversedStacks", new ConfigOption("reversedStacks", null, true, this.ReversedStacks));
                ...
                list.Add("startOnTick", new ConfigOption("startOnTick", null, true, this.StartOnTick));

                list.Add("stops", new ConfigOption("stops", new SerializationOptions("stops", JsonMode.AlwaysArray), "", this.Stops));
                ...
                list.Add("tickWidth", new ConfigOption("tickWidth", null, 0, this.TickWidth));
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
            ...
            public YAxisEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new YAxisEvents();
					}
        ...
        public partial class Labels : Observable
        {
            ...
            [NotifyParentProperty(true)]
            [Category("HighChart")]
            [Description(@"What part of the string the given position is anchored to. 		Can be one of ""left"", ""center"" or ""right"".")]
            public string Align
            {
                get
                {
            ...
            public double? y
            {
                get
                {
                    return this.State.Get<double?>("y", 3);
                }
                set
                {
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("y", new ConfigOption("y", null, 3, this.y));
        ...
        public partial class Title : Observable
        {
            ...
            public double? Margin
            {
                get
                {
                    return this.State.Get<double?>("Margin", 40);
                }
                set
                {
            ...
            public double? Rotation
            {
                get
                {
                    return this.State.Get<double?>("Rotation", 270);
                }
                set
                {
                    this.State.Set("Rotation", value);
            ...
            [NotifyParentProperty(true)]
            [Category("HighChart")]
            [Description(@"The actual text of the axis title. Horizontal texts can contain HTML,  but rotated texts are painted using vector techniques and must be  clean text. The Y axis title is disabled by setting the text option to null.")]
            public string Text
            {
                get
                {
                    return this.State.Get<string>("Text", @"Values");
                }
                set
                {
                    this.State.Set("Text", value);
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("margin", new ConfigOption("margin", null, 40, this.Margin));

                list.Add("offset", new ConfigOption("offset", null, null, this.Offset));

                list.Add("rotation", new ConfigOption("rotation", null, 270, this.Rotation));

                list.Add("style", new ConfigOption("style", null, @"{ ""color"": ""#707070"", ""fontWeight"": ""bold"" }", this.Style));

                list.Add("text", new ConfigOption("text", null, @"Values", this.Text));
        ...
        /// Client Side Events#
        /// </summary>
        public partial class YAxisEvents : ComponentListeners
        {
