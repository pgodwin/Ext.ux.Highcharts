...
namespace Ext.ux.Highcharts.Chart
{
        ...
        [DefaultValue(null)]
        [Category("HighCharts")]
        [ConfigOption("stackLabels", typeof(LazyControlJsonConverter))]
        [PersistenceMode(PersistenceMode.InnerProperty)]
        [Description(@"The stack labels show the total value for each bar in a stacked column or bar chart. The label will be placed on top of	positive columns and below negative columns. In case of an inverted column chart or a bar chart the label is placed to 	the right of positive bars and to the left of negative bars.")]
        public virtual StackLabels StackLabels
        {
            get
            {
                return this._StackLabels;
            }
            set
            {
                if (this._StackLabels != null)
                {
                    this.Controls.Remove(this._StackLabels);
                    this.LazyItems.Remove(this._StackLabels);
                }

                this._StackLabels = value;

                if (this._StackLabels != null)
                {
                    this.LazyItems.Add(this._StackLabels);
                    this.Controls.Add(this._StackLabels);
                }
            }
        }
