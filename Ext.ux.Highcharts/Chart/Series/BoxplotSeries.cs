...
namespace Ext.ux.Highcharts.ChartSeries
{
        ...
        /// </summary>
        public partial class BoxplotSeries : BaseBoxPlotSerie
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private BoxplotSeriesEvents events;
            ...
            public BoxplotSeriesEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new BoxplotSeriesEvents();
					}
