...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private AreasplineSeriesEvents events;
            ...
            public AreasplineSeriesEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new AreasplineSeriesEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class AreasplineSeriesEvents : ComponentListeners
        {
