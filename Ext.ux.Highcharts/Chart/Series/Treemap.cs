...
namespace Ext.ux.Highcharts.ChartSeries
{
        ...
        /// </summary>
        public partial class Treemap : Series
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
        ...
        public partial class Data : Observable
        {
            ...
            public double? ColorValue
            {
                get
                {
                    return this.State.Get<double?>("ColorValue", null);
                }
                set
                {
                    this.State.Set("ColorValue", value);
                }
            }
            ...
            public string Parent
            {
                get
                {
                    return this.State.Get<string>("Parent", null);
                }
                set
                {
                    this.State.Set("Parent", value);
                }
            }
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("colorValue", new ConfigOption("colorValue", null, null, this.ColorValue));
                ...
                list.Add("parent", new ConfigOption("parent", null, null, this.Parent));
