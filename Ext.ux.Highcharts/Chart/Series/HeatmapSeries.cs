...
namespace Ext.ux.Highcharts.ChartSeries
{
        ...
        /// </summary>
        public partial class HeatmapSeries : BaseHeatmapSerie
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private HeatmapSeriesEvents events;
            ...
            public HeatmapSeriesEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new HeatmapSeriesEvents();
					}
