...
namespace Ext.ux.Highcharts.ChartSeries
{
        ...
        /// </summary>
        public partial class WaterfallSeries : BaseWaterfallSerie
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private WaterfallSeriesEvents events;
            ...
            public WaterfallSeriesEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new WaterfallSeriesEvents();
					}
