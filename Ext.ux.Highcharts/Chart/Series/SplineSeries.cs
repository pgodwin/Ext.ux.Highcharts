...
namespace Ext.ux.Highcharts.ChartSeries
{
        ...
        /// </summary>
        public partial class SplineSeries : BaseSplineSerie
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private SplineSeriesEvents events;
            ...
            public SplineSeriesEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new SplineSeriesEvents();
					}
