...
namespace Ext.ux.Highcharts.ChartSeries
{
        ...
        /// <summary>
        /// A area series. If the .type">type option is not specified, it is inherited from chart.type.For options that apply to multiple series, it is recommended to add them to the pointOptions.series options structure. To apply to all series of this specific type, apply it to plotOptions.area.
        /// </summary>
        public partial class AreaSeries : BaseAreaSerie
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private AreaSeriesEvents events;
            ...
            public AreaSeriesEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new AreaSeriesEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class AreaSeriesEvents : ComponentListeners
        {
