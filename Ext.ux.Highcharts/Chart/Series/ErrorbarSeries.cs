...
namespace Ext.ux.Highcharts.ChartSeries
{
        ...
        /// </summary>
        public partial class ErrorbarSeries : BaseErrorBarSerie
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private ErrorbarSeriesEvents events;
            ...
            public ErrorbarSeriesEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new ErrorbarSeriesEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class ErrorbarSeriesEvents : ComponentListeners
        {
