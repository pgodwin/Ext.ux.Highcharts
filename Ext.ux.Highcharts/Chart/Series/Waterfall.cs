...
namespace Ext.ux.Highcharts.ChartSeries
{
        ...
        /// <summary>
        /// A waterfall series. If the .type">type option is not specified, it is inherited from chart.type.For options that apply to multiple series, it is recommended to add them to the pointOptions.series options structure. To apply to all series of this specific type, apply it to plotOptions.waterfall.
        /// </summary>
        public partial class Waterfall : BaseWaterfallSerie //Series
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
        ...
        public partial class Data : Observable
        {
            ...
            /// </summary>
            [ConfigOption("isIntermediateSum", null)]
            [DefaultValue(false)]
            [NotifyParentProperty(true)]
            [Category("HighChart")]
            ...
            public bool? IsIntermediateSum
            {
                get
                {
                    return this.State.Get<bool?>("IsIntermediateSum", false);
                }
                set
                {
                    this.State.Set("IsIntermediateSum", value);
                }
            }
            ...
            public bool? IsSum
            {
                get
                {
                    return this.State.Get<bool?>("IsSum", false);
                }
                set
                {
                    this.State.Set("IsSum", value);
                }
            }
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
            get
            {
                ...
                list.Add("isIntermediateSum", new ConfigOption("isIntermediateSum", null, false, this.IsIntermediateSum));

                list.Add("isSum", new ConfigOption("isSum", null, false, this.IsSum));
