...
namespace Ext.ux.Highcharts.ChartSeries
{
        ...
        /// </summary>
        public partial class PieSeries : BasePieSerie
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private PieSeriesEvents events;
            ...
            public PieSeriesEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new PieSeriesEvents();
					}
