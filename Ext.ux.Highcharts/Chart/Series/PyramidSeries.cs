...
namespace Ext.ux.Highcharts.ChartSeries
{
        ...
        /// </summary>
        public partial class PyramidSeries : BasePyramidSerie
        {
        ...
        public override ConfigOptionsCollection ConfigOptions
        {
	        ...
	        private PyramidSeriesEvents events;
            ...
            public PyramidSeriesEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new PyramidSeriesEvents();
					}
