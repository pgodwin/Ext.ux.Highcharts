...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// 
        /// </summary>
        public partial class AreasplinePlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private AreasplinePlotOptionsEvents events;
            ...
            public AreasplinePlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new AreasplinePlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class AreasplinePlotOptionsEvents : ComponentListeners
        {
