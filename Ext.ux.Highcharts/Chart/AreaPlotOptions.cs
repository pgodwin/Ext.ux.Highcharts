...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// 
        /// </summary>
        public partial class AreaPlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private AreaPlotOptionsEvents events;
            ...
            public AreaPlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new AreaPlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class AreaPlotOptionsEvents : ComponentListeners
        {
