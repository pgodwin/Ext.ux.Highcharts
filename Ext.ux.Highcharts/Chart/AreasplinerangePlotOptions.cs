...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// </summary>
        public partial class AreasplinerangePlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private AreasplinerangePlotOptionsEvents events;
            ...
            public AreasplinerangePlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new AreasplinerangePlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class AreasplinerangePlotOptionsEvents : ComponentListeners
        {
