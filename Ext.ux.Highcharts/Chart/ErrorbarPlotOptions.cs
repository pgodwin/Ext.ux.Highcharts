...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// </summary>
        public partial class ErrorbarPlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private ErrorbarPlotOptionsEvents events;
            ...
            public ErrorbarPlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new ErrorbarPlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class ErrorbarPlotOptionsEvents : ComponentListeners
        {
