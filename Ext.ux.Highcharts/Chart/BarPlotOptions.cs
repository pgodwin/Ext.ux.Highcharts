...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// 
        /// </summary>
        public partial class BarPlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private BarPlotOptionsEvents events;
            ...
            public BarPlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new BarPlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class BarPlotOptionsEvents : ComponentListeners
        {
