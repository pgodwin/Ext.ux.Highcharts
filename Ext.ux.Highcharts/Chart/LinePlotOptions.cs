...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// 
        /// </summary>
        public partial class LinePlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private LinePlotOptionsEvents events;
            ...
            public LinePlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new LinePlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class LinePlotOptionsEvents : ComponentListeners
        {
