...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// </summary>
        public partial class ColumnrangePlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private ColumnrangePlotOptionsEvents events;
            ...
            public ColumnrangePlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new ColumnrangePlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class ColumnrangePlotOptionsEvents : ComponentListeners
        {
