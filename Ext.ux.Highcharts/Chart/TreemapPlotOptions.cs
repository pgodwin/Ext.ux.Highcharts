...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// </summary>
        public partial class TreemapPlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private TreemapPlotOptionsEvents events;
            ...
            public TreemapPlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new TreemapPlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class TreemapPlotOptionsEvents : ComponentListeners
        {
