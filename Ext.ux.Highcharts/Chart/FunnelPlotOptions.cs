...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// </summary>
        public partial class FunnelPlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private FunnelPlotOptionsEvents events;
            ...
            public FunnelPlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new FunnelPlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class FunnelPlotOptionsEvents : ComponentListeners
        {
