...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// </summary>
        public partial class ArearangePlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private ArearangePlotOptionsEvents events;
            ...
            public ArearangePlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new ArearangePlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class ArearangePlotOptionsEvents : ComponentListeners
        {
