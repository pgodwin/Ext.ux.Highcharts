...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// 
        /// </summary>
        public partial class ColumnPlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private ColumnPlotOptionsEvents events;
            ...
            public ColumnPlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new ColumnPlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class ColumnPlotOptionsEvents : ComponentListeners
        {
