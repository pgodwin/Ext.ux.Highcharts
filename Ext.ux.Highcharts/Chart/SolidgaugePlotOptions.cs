...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// </summary>
        public partial class SolidgaugePlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private SolidgaugePlotOptionsEvents events;
            ...
            public SolidgaugePlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new SolidgaugePlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class SolidgaugePlotOptionsEvents : ComponentListeners
        {
