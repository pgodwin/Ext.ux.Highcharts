...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// </summary>
        public partial class HeatmapPlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private HeatmapPlotOptionsEvents events;
            ...
            public HeatmapPlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new HeatmapPlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class HeatmapPlotOptionsEvents : ComponentListeners
        {
