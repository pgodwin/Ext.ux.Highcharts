...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// </summary>
        public partial class GaugePlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private GaugePlotOptionsEvents events;
            ...
            public GaugePlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new GaugePlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class GaugePlotOptionsEvents : ComponentListeners
        {
