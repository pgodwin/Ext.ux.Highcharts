...
namespace Ext.ux.Highcharts.Chart
{
        ...
        /// </summary>
        public partial class PolygonPlotOptions : Observable
        {
...
list.Add("events", new ConfigOption("events", new SerializationOptions("events", JsonMode.Object), null, this.Listeners));
	        ...
	        private PolygonPlotOptionsEvents events;
            ...
            public PolygonPlotOptionsEvents Listeners
			{
				get
				{
					if (this.events == null)
					{
						this.events = new PolygonPlotOptionsEvents();
					}
        ...
        /// Client Side Events#
        /// </summary>
        public partial class PolygonPlotOptionsEvents : ComponentListeners
        {
